...
public class LoginPage extends TestListeners
{
	...
	//@FindBy(xpath= "//header/div[1]/div[3]/div[2]/a[1]/img[1]")   //Profile button
	//private WebElement ProfileBtn;
	
	@FindBy(xpath = "(//img[@name='ProfileImage_header'])[1]")
	private WebElement ProfileBtn;
	
	//@FindBy(xpath = "//select[@data-autoid='BM_ctrl']")
