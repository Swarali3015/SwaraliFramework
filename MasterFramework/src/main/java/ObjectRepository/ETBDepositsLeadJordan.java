...
public class ETBDepositsLeadJordan extends SetUp
{

	//public static Logger log =LogManager.getLogger(LoginPage.class.getName());
	
			public ETBDepositsLeadJordan(WebDriver driver)
			{
				this.driver = driver;
				PageFactory.initElements(driver, this);
			}
			
			//ETB Leads PC=Deposits
			...
			public void ETBDeposits(String sheetName) throws Exception
			{
