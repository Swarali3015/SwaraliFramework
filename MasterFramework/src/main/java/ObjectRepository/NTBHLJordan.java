...
public class NTBHLJordan extends SetUp
{

	public NTBHLJordan(WebDriver driver) 
	{
		this.driver = driver;
	...
	private WebElement BackendReferenceNumber;

	
	
	public void Loans(String sheetName) throws Exception
	{
		...
		Thread.sleep(2000);
		CommonMethods.highLight(PL);
		Thread.sleep(2000);
		CommonMethods.Click(PL);
		Thread.sleep(2000);
		CommonMethods.selectByText(ProductCategory, sheetName, "Product Category", 1);
		...
		Thread.sleep(3000);
		CommonMethods.highLight(BackendReferenceNumber);
		CommonMethods.input(BackendReferenceNumber, sheetName, "Backend Reference Number", 1);
		Thread.sleep(2000);
		CommonMethods.Click(SaveProceed2);
		Thread.sleep(1000);
		CommonMethods.Click(LeadOwner);
