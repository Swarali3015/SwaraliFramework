...
public class NTBCASAJordanSCTerminated extends SetUp

{

	//public static Logger log =LogManager.getLogger(LoginPage.class.getName());
	
	public NTBCASAJordanSCTerminated(WebDriver driver)
	{
		this.driver = driver;
	...
	@FindBy(xpath = "//span[contains(text(),'CASA')]")
	...
	@FindBy(xpath = "//span[contains(text(),'Terminated')]")			//Rejected
	private WebElement Terminated;
	...
	public void Casa(String sheetName) throws Exception
	{
		...
		Thread.sleep(3000);
		CommonMethods.Click(Terminated);
		Thread.sleep(3000);
		CommonMethods.Click(SaveProceed2);
		Thread.sleep(1000);
		CommonMethods.Click(LeadOwner);
