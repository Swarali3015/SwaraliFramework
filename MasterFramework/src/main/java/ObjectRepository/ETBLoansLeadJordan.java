...
public class ETBLoansLeadJordan extends SetUp
{

	public ETBLoansLeadJordan(WebDriver driver) 
	{
		this.driver = driver;
	...
	public void ETBLoans(String sheetName) throws Exception
	{
		...
		CommonMethods.selectByText(ProductType, sheetName, "Product Category", 1);
