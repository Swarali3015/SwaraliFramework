...
public class CommonMethods extends SetUp 
{
	...
	public static void ExWait(String locator) throws Exception
	{
		...
		{
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(CommonMethods.readPropertyFile(locator))));
		}
		else if (locator.endsWith("_CSS"))
		{
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(CommonMethods.readPropertyFile(locator))));
		}
	...
	public static void Click(String locator)
	{
		try {
			...
			if (locator.endsWith("_XPATH")) {
				...
				driver.findElement(By.cssSelector(CommonMethods.readPropertyFile(locator))).click();
			} 
